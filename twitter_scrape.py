...
#connecting python to mongo database
...
with left_column:     
    ...
    #creating a list to append data and passing it into pandas dataframe.......
    tweets=[]
    ...
    #To load the searched data into mongodb as a document:
        ...
        if st.button('Upload File') is not None:
            ...
            #To convert the today's date from object to string
            now=datetime.now()
